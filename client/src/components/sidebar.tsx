...
export default function Sidebar({ onClose }: SidebarProps) {
  ...
  return (
    <aside className="w-64 h-screen bg-gradient-to-b from-blue-550 to-purple-50 dark:bg-gray-900/95 backdrop-blur-lg shadow-xl border-r border-gray-200/50 dark:border-gray-700/50 relative inset-y-0 left-0 z-30 flex flex-col p-4">
      <div className="sticky top-0 z-10 -m-4 mb-6 flex items-center justify-between bg-gradient-to-b from-blue-550 to-purple-50 dark:from-gray-900/95 dark:to-gray-900/95 px-4 pt-4 pb-3">
        ...
        <div className="flex items-center gap-2">
          ...
          {onClose && (
            <Button
              variant="secondary"
              size="sm"
              className="md:hidden border border-gray-200 dark:border-gray-800 gap-2"
              onClick={onClose}
