          ...
          <div className="lg:col-span-3">
            ...
            >
              <CardHeader>
                ...
                <CardDescription>
                  {latestAdvice
                    ? "Your most recent AI-generated career advice"
                    : "Generate your first career advice to see personalized guidance"}
                </CardDescription>
              </CardHeader>
              <CardContent>
                {isLoadingAdvisories ? (
                  ...
                  <div className="space-y-6 max-w-none">
                    ...
                    {/* Recommendations */}
                    {latestAdvice.recommendations &&
                      latestAdvice.recommendations.length > 0 && (
                        <div className="bg-white rounded-xl p-6 shadow-sm border border-blue-200">
                          ...
                          <ul className="space-y-3">
                            {latestAdvice.recommendations.map(
                    ...
                    {/* Skill Gaps */}
                    {latestAdvice.skillGaps &&
                      latestAdvice.skillGaps.length > 0 && (
                        <div>
                          <h4 className="font-medium text-sm text-muted-foreground mb-2">
                            Skills to Develop
                          </h4>
                          <div className="flex flex-wrap gap-1">
                            {latestAdvice.skillGaps.map(
                    ...
                    {/* Next Steps */}
                    {latestAdvice.nextSteps &&
                      latestAdvice.nextSteps.length > 0 && (
                        <div>
                          <h4 className="font-medium text-sm text-muted-foreground mb-2">
                            Next Steps
                          </h4>
                          <ul className="space-y-1">
                            {latestAdvice.nextSteps.map(
                    ...
                    <div className="text-xs text-muted-foreground pt-2 border-t">
                      Generated on{" "}
                      {new Date(latestAdvice.createdAt).toLocaleDateString()}
                    </div>
                  </div>
                ) : (
                  <div className="text-center py-8">
        ...
        {advisoriesArray.length > 1 && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Your career advice history</CardDescription>
            </CardHeader>
            <CardContent>
