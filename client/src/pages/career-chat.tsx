        ...
        <div className="lg:col-span-1">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Your career conversations
              </CardDescription>
            </CardHeader>
            <CardContent>
              {/* New Session Form */}
              {isCreatingSession && (
                <form onSubmit={handleCreateSession} className="space-y-3 mb-4 p-3 border rounded-lg">
                  ...
                  (sessions as any[]).map((session: any) => (
                    <div
                      ...
                      className={`p-3 rounded-lg border cursor-pointer transition-all ${
                        selectedSessionId === session.id ? 'border-orange-600 bg-orange-50' : 'hover:border-orange-300'
                      }`}
                          ...
                          >
                            <div className={`flex gap-3 max-w-[80%] ${msg.role === 'user' ? 'flex-row-reverse' : 'flex-row'}`}>
                              <div className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 ${
                                msg.role === 'user' ? 'bg-blue-600' : 'bg-orange-600'
                              }`}>
                                {msg.role === 'user' ? (
