...
export default function CareerChat() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      {/* Main Content */}
      <main className="lg:ml-64 px-10 pt-4 h-screen overflow-y-auto">
        <Card className="mb-4 bg-gradient-to-r from-red-600 via-white-600 to-orange-400 text-white border-0 shadow-2xl">
            ...
            <div className="flex justify-between items-center">
              <div className="space-y-2">
                ...
                <p className="text-blue-100 text-lg">
                  Have interactive conversations with your personal AI career
                  counselor. Get instant answers to career questions and
