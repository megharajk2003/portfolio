...
export class AICareerService {
  static async generateCareerAdvice(
    ...
    try {
      ...
      console.log(
        "🤖 [AI-SERVICE] Sending request to Google AI for career advice"
      );
      ...
      console.log(
        "🤖 [AI-SERVICE] Google AI response received:",
        response.response.text()
      );
      const result = JSON.parse(response.response.text() || "{}");
      console.log(
        "✅ [AI-SERVICE] Career advice generated successfully:",
        result
      );
      return result;
    } catch (error) {
  ...
  static async generateCareerTimeline(
    userData: UserProfileData,
    targetRole: string
  ): Promise<{
    title: string;
    ...
    try {
      ...
      const response = await model.generateContent(prompt);
      console.log(
        "🤖 [AI-SERVICE] Timeline Google AI response:",
        response.response.text()
      );
      const result = JSON.parse(response.response.text() || "{}");
  ...
  static async generateResume(
    ...
    try {
      ...
      const response = await model.generateContent(prompt);
      console.log(
        "🤖 [AI-SERVICE] Resume Google AI response:",
        response.response.text()
      );
      const result = JSON.parse(response.response.text() || "{}");
  ...
  static async generateChatResponse(
    ...
    try {
      ...
      console.log(
        "🤖 [AI-SERVICE] Chat Google AI response:",
        response.response.text()
      );
      return (
        response.response.text() ||
