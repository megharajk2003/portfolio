...
export class PgStorage implements IStorage {
  ...
  private seedBadgesInFallback() {
    const badgeData = [
      ...
      // Goal Achievement Badges - Bronze Tier
      {
        id: "badge-goal-starter",
        title: "Goal Starter",
      ...
      // Goal Achievement Badges - Silver Tier
      {
        id: "badge-goal-guardian",
        title: "Goal Guardian",
      ...
      {
        id: "badge-silver-sentinel",
        title: "Silver Sentinel",
        description: "Complete 30 goals",
        icon: "Award",
        color: "silver",
        type: "milestone",
        criteria: { goalsCompleted: 30 },
        xpReward: 250,
        rarity: "epic",
        createdAt: new Date(),
      },
      {
        id: "badge-focused-finisher",
        title: "Focused Finisher",
        description: "Complete 40 goals",
        icon: "Focus",
        color: "silver",
        type: "milestone",
        criteria: { goalsCompleted: 40 },
        xpReward: 300,
        rarity: "epic",
        createdAt: new Date(),
      },
      ...
      {
        id: "badge-accomplishment-ace",
        title: "Accomplishment Ace",
        description: "Complete 60 goals",
        icon: "Star",
        color: "silver",
        type: "milestone",
        criteria: { goalsCompleted: 60 },
        xpReward: 450,
        rarity: "epic",
        createdAt: new Date(),
      },

      // Goal Achievement Badges - Gold Tier
      {
        id: "badge-golden-gladiator",
        title: "Golden Gladiator",
        description: "Complete 75 goals",
        icon: "Sword",
        color: "gold",
        type: "milestone",
        criteria: { goalsCompleted: 75 },
        xpReward: 500,
        rarity: "legendary",
        createdAt: new Date(),
      },
      {
        id: "badge-goal-grandmaster",
      ...
      {
        id: "badge-centurion-success",
        title: "Centurion of Success",
        description: "Complete 125 goals",
        icon: "Medal",
        color: "gold",
        type: "milestone",
        criteria: { goalsCompleted: 125 },
        xpReward: 800,
        rarity: "legendary",
        createdAt: new Date(),
      },
      {
        id: "badge-milestone-master",
        title: "Milestone Master",
        description: "Complete 150 goals",
        icon: "Trophy",
        color: "gold",
        type: "milestone",
        criteria: { goalsCompleted: 150 },
        xpReward: 900,
        rarity: "legendary",
        createdAt: new Date(),
      },
      {
        id: "badge-virtuoso-victory",
        title: "Virtuoso of Victory",
        description: "Complete 175 goals",
        icon: "Star",
        color: "gold",
        type: "milestone",
        criteria: { goalsCompleted: 175 },
        xpReward: 1000,
        rarity: "legendary",
        createdAt: new Date(),
      },

      // Goal Achievement Badges - Platinum Tier
      {
        id: "badge-platinum-planner",
      ...
      {
        id: "badge-diamond-dominator",
        title: "Diamond Dominator",
        description: "Complete 250 goals",
        icon: "Gem",
        color: "platinum",
        type: "milestone",
        criteria: { goalsCompleted: 250 },
        xpReward: 1500,
        rarity: "legendary",
        createdAt: new Date(),
      },
      {
        id: "badge-titan-tasks",
        title: "Titan of Tasks",
        description: "Complete 300 goals",
        icon: "Mountain",
        color: "platinum",
        type: "milestone",
        criteria: { goalsCompleted: 300 },
        xpReward: 2000,
        rarity: "legendary",
        createdAt: new Date(),
      },
      {
        id: "badge-legend-accomplishment",
        title: "Legend of Accomplishment",
        description: "Complete 400 goals",
        icon: "Crown",
        color: "platinum",
        type: "milestone",
        criteria: { goalsCompleted: 400 },
        xpReward: 2500,
        rarity: "legendary",
        createdAt: new Date(),
      },
      {
        id: "badge-skillstream-sovereign",
      ...
      switch (badge.type) {
        ...
        case "milestone":
          ...
          if (criteria?.skillsAdded) {
            ...
            const totalSkills = Object.values(otherDetails.skills).reduce(
              (total: number, skillArray: any) => {
                return (
                  total + (Array.isArray(skillArray) ? skillArray.length : 0)
                );
              },
              0
            );
        ...
        case "achievement":
          ...
          if (criteria?.profileCompleted) {
            ...
            if (contactDetails?.linkedin || contactDetails?.githubOrPortfolio)
              completionScore += 10;

            // Other details (40 points max)
            if (otherDetails?.education && otherDetails.education.length > 0)
              completionScore += 10;
            if (
              otherDetails?.workExperience &&
              otherDetails.workExperience.length > 0
            )
              completionScore += 10;
            if (
              otherDetails?.skills &&
              Object.keys(otherDetails.skills).some(
                (key) => otherDetails.skills[key]?.length > 0
              )
            )
              completionScore += 10;
            if (otherDetails?.projects && otherDetails.projects.length > 0)
              completionScore += 10;
          ...
          if (criteria?.projectsAdded) {
            ...
            const otherDetails = profile.otherDetails as any;
            return (
              (otherDetails?.projects?.length || 0) >= criteria.projectsAdded
            );
          }
          ...
          if (criteria?.educationAdded) {
            ...
            const otherDetails = profile.otherDetails as any;
            return (
              (otherDetails?.education?.length || 0) >= criteria.educationAdded
            );
          }
          if (criteria?.bioAdded) {
            ...
            const personalDetails = profile.personalDetails as any;
            return !!(
              personalDetails?.summary && personalDetails.summary.length > 10
            );
          }
